// This file defines linapro-extid-core business error codes and runtime i18n metadata.
...
var (
	...
	CodeIdentityInvalid = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_IDENTITY_INVALID",
	...
	CodeIdentityQueryFailed = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_IDENTITY_QUERY_FAILED",
	...
	CodeIdentityWriteFailed = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_IDENTITY_WRITE_FAILED",
	...
	CodeIdentityNotFound = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_IDENTITY_NOT_FOUND",
	...
	CodeBindConflict = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_BIND_CONFLICT",
	...
	CodeProvisionNotAllowed = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_PROVISION_NOT_ALLOWED",
	...
	CodeProvisionEmailConflict = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_PROVISION_EMAIL_CONFLICT",
	...
	CodeProvisionFailed = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_PROVISION_FAILED",
	...
	CodeUserCapabilityUnavailable = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_USER_CAPABILITY_UNAVAILABLE",
	...
	CodeTicketInvalid = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_TICKET_INVALID",
	...
	CodeTicketUnavailable = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_TICKET_UNAVAILABLE",
	...
	CodeProviderNotFound = bizerr.MustDefine(
		"PLUGIN_EXTID_CORE_PROVIDER_NOT_FOUND",
