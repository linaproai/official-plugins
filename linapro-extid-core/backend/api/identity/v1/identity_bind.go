...
type BindIdentityReq struct {
	...
	TicketID string `json:"ticketId" v:"required|length:1,128" dc:"Single-use verified-identity ticket issued by linapro-extid-core after protocol verification" eg:"extid_ab12..."`
}
