...
type GetSettingsReq struct {
	g.Meta `path:"/settings" method:"get" tags:"Generic OIDC Login" summary:"Query Generic OIDC settings" dc:"Return persisted linapro-oidc-generic settings. Client secret is always masked." permission:"linapro-oidc-generic:settings:view"`
}
