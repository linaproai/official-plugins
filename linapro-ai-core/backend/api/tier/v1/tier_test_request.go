...
type TestReq struct {
	g.Meta          `path:"/ai/tiers/{code}/test" method:"post" tags:"AI Tiers" summary:"Test AI capability tier" dc:"Execute a lightweight text generation test against a saved or draft tier binding without persisting draft binding changes." permission:"ai:tier:test"`
