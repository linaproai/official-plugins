...
type UpdateReq struct {
	g.Meta        `path:"/ai/tiers/{code}" method:"put" tags:"AI Tiers" summary:"Update AI capability tier" dc:"Update one text AI capability tier, including enabled state, default thinking effort, and primary provider-model binding." permission:"ai:tier:update"`
