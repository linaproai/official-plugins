...
type GetSettingsReq struct {
	g.Meta `path:"/plugin/linapro-oidc-discord/settings" method:"get" tags:"Discord OAuth2" summary:"Get Discord OAuth2 settings" dc:"Retrieve the current Discord OAuth2 login plugin configuration. The client secret is masked in the response. Provider enablement is controlled by host plugin status." permission:"linapro-oidc-discord:settings:view"`
}
