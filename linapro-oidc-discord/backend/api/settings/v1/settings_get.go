...
type GetSettingsReq struct {
	g.Meta `path:"/settings" method:"get" tags:"Discord OIDC Login" summary:"Query Discord OIDC settings" dc:"Return the persisted linapro-oidc-discord settings for the admin settings page. The client secret is always returned as a masked indicator; plaintext secrets are never sent to the client." permission:"linapro-oidc-discord:settings:view"`
}
