// This file defines Discord OAuth controller business error codes.
...
var (
	// CodeOAuthProviderDisabled reports that the Discord provider is not
	...
	// CodeOAuthSettingsUnavailable reports that Discord OAuth settings are
	...
	// could not be built from the configured Discord OAuth settings.
	...
	// CodeOAuthEmailNotVerified reports that Discord did not return a verified
	// email address.
